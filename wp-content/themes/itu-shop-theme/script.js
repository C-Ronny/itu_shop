document.addEventListener('DOMContentLoaded', function() {
    ...
    function normalizeCategory(category) {
        // Remove text in parentheses (e.g., "(ITU-R)")
    ...
    function fetchProducts(page, category = '') {
        ...
        const apiUrl = `${ituAjax.rest_url}?page=${page}${category ? `&category=${encodeURIComponent(category)}` : ''}`;
        ...
        .then(({ response, text }) => {
            ...
            if (response.ok && data.products) {
                ...
                if (category) {
                    ...
                    console.log('Filtered products:', filteredProducts.length, 'Category:', category, 'Normalized:', normalizedCategory);
                }
